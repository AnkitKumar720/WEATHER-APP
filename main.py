...
# frame_three = tk.Frame(bg_lbl,bg='#8d90a1',bd=5)
# frame_three.place(x=420,y=460,width=160,height=30)
# Title = tk.Label(frame_three,text='By:- Ankit',fg='white',bg='#81869a',font=('times new roman',16,'bold'))
# Title.place(x=420,y=460)

headingg_title = tk.Label(bg_lbl,text='By:- Ankit',fg='#fdfdfd',bg='#81869a',font=('times new roman',16,'bold'))
headingg_title.place(x=420,y=460,width=160,height=30)
